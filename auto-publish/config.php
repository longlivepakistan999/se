...
// Claude API
define( 'QWE_CLAUDE_API_KEY', '' ); // sk-ant-... (set your Claude API key here)	
...
// ============================================================
// Register ai-tool post type on every WordPress load.
// This ensures archives and single pages work on the frontend.
// ============================================================
